...
admin.add_food_item("Cheeseburger", 10, 5.99, 0.25, 50, menu)
admin.add_food_item("Pizza", 1, 10.99, 0.2, 10, menu)
# View the menu
admin.view_food_items(menu)

# Edit a food item in the menu
admin.edit_food_item(1000, "Veggie Burger", 8, 6.99, 0.3, 40, menu)

# Remove a food item from the menu
admin.remove_food_item(1000, menu)

# Create a new user
user = User("John Smith", "555-1234", "john@example.com", "123 Main St", "password")
